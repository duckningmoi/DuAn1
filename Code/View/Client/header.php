            ...
            <form class="box_search" action="index.php?act=sanpham" method="POST">
                ...
                <button  class="btn_timkiem" type="submit" name="timkiem"><i class="fa-solid fa-magnifying-glass"></i></button>
                    ...
                    <?php if(isset($_SESSION['user'])){ ?>
                        ...
                        <a href="index.php?act=tttk"><img style="border-radius: 30%;" src="Images/<?= $avatar['avatar'] ?>" alt="" width="25px" height="25px"></a>
                    <?php } else{ ?>
        ...
        <nav>
            ...
            <ul>
                ...
                <?php foreach($all_danhmuc as $danhmuc) { ?>
                    <a class="link_menu" href="index.php?act=sanpham&iddm=<?= $danhmuc['id_danhmuc'] ?>"><?= $danhmuc['ten_danhmuc'] ?></a>
                    <?php } ?>  
                    </div>          
                </li>
                <li><a class="link_menu" href="index.php?act=blog">Blog</a></li>
                <li><a class="link_menu" href="index.php?act=contact">Contact</a></li>
                <li><a class="link_menu" href="index.php?act=about">About</a></li>
                <li><a class="link_menu" href="https://web.facebook.com/?_rdc=1&_rdr">Vergency Group</a></li>
                <li><a class="link_menu" href="https://www.instagram.com/">Vergency Instagram</a></li>
            </ul>
