...
<div class="contact-page">
        ...
        <form accept-charset="UTF-8" action="/contact" class="contact-form" method="post">
            ...
            <div class="contact-form page-form-contact">
                <div class="clearfix">
                    ...
                    <div class="contact-item">
                        <div class="input-group">
                            <textarea style="width: 180px; height: 130px" name="contact[body]" placeholder="Viết lời nhắn"></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="page-right-title">
        ...
        <hr>
        <div class="phone">
            <i class="fa fa-building" aria-hidden="true"></i> Vergency.
        </div>
        <div class="phone">
            <i class="fa fa-phone" aria-hidden="true"></i> 035 319 5203.
        </div>
        <div class="phone">
            <i class="fa fa-map-marker" aria-hidden="true"></i> Cao đẳng FPT Phố Trịnh Văn Bô , Phường Phương Canh , quận Từ Liêm KH vui lòng đến đúng khung giờ mở cửa trên để mua hàng. Vergency chân thành cảm ơn!
        </div>
        <div class="phone">
            <i class="fa fa-envelope" aria-hidden="true"></i> ninhbdph38429@fpt.edu.vn
        </div>
    </div>
</div>