...
<!-- component -->
<div id="team" class="section pt-20 pb-8 md:pt-16 bg-white dark:bg-gray-800">
            ...
            <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="https://scontent.fhan2-3.fna.fbcdn.net/v/t39.30808-1/305658115_1786399085054342_8669208477070786724_n.jpg?stp=dst-jpg_p320x320&_nc_cat=108&ccb=1-7&_nc_sid=5740b7&_nc_ohc=LyU-tYzfDxUAX8Ews3m&_nc_ht=scontent.fhan2-3.fna&oh=00_AfAt_T_jlVwVuWQ0asRipec_Y9xPivYYE5pqMN5O8m02FQ&oe=65707EB4" class="max-w-full h-auto mx-auto rounded-full bg-gray-50" alt="title image">
                    </div>
                    <div class="pt-6 text-center">
                        <p class="text-lg leading-normal font-bold mb-1">Vương Đức Anh</p>
